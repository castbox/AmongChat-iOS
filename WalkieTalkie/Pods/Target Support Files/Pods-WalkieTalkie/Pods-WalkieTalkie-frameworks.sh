...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CastboxDebuger/CastboxDebuger.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Moya-iOS10.0/Moya.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Path.swift/Path.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxSwift-iOS10.0/RxSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyUserDefaults-iOS10.0/SwiftyUserDefaults.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UIColor_Hex_Swift/UIColor_Hex_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WSFlexibleTouch/WSFlexibleTouch.framework"
