...
//extension Reactive where Base: ApiManager<T> {
//    func request(_ target: APIService.WalkieTalkie, callbackQueue: DispatchQueue? = nil) -> Observable<Json> {
//        return base.reactiveRequest(target, callbackQueue: callbackQueue)
//    }
//
//    func requestWithRawDataResponse(_ target: APIService.WalkieTalkie, callbackQueue: DispatchQueue? = nil) -> Observable<Data> {
//        return base.reactiveRequestWithRawDataResponse(target, callbackQueue: callbackQueue)
//    }
//}
//
//extension ApiManager {
//    func reactiveRequest(_ target: APIService.WalkieTalkie, callbackQueue: DispatchQueue? = nil) -> Observable<Json> {
...
//    }
//
//    func reactiveRequestWithRawDataResponse(_ target: APIService.WalkieTalkie, callbackQueue: DispatchQueue? = nil) -> Observable<Data> {
//        return Observable.create { [weak self] observer in
