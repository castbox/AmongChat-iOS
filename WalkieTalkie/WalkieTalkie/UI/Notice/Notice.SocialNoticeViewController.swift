...
extension Notice {
    ...
    class SocialNoticeViewController: WalkieTalkie.ViewController {
        ...
        private lazy var socialNoticeListView: UICollectionView = {
            ...
            v.register(GroupMessageCell.self, forCellWithReuseIdentifier: NSStringFromClass(GroupMessageCell.self))
            v.register(UserMessageCell.self, forCellWithReuseIdentifier: NSStringFromClass(UserMessageCell.self))
...
extension Notice.SocialNoticeViewController {
    ...
    private func setUpLayout() {
        view.addSubviews(views: emptyView, socialNoticeListView)
        ...
        socialNoticeListView.snp.makeConstraints { (maker) in
            maker.edges.equalToSuperview()
        }
        
        socialNoticeListView.pullToRefresh { [weak self] in
            self?.loadData(refresh: true)
        }
        
        socialNoticeListView.pullToLoadMore { [weak self] in
            self?.loadData()
        }
    }
...
extension Notice.SocialNoticeViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(GroupMessageCell.self), for: indexPath)
        return cell
    }
}

extension Notice.SocialNoticeViewController: UICollectionViewDelegate {
